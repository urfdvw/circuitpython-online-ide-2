...
const WhatSNew = ({ text, open, onClose }) => {
  ...
  return (
    <Dialog
      open={open}
      onClose={onClose}
      maxWidth="md" // Slightly wider for better reading
      fullWidth
    ...
    >
      ...
      >
        {/* A celebratory icon */}
        <Typography variant="h4" component="span" role="img" aria-label="party popper">
          🎉
        </Typography>
        <Typography
          variant="h5"
      ...
      <DialogContent
        dividers
        sx={{
          height: '450px', // FIXED HEIGHT defined here
