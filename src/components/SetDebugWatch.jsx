...
const SetDebugWatch = ({
  ...
  useEffect(() => {
    ...
    const validDebugFiles = debugFileNames.filter((fileName) =>
      pythonFileNames.includes(fileName)
    );
  ...
  const flattenedRows = useMemo(() => {
    ...
    const fileKeys = Object.keys(watchExpressions).filter(k => k !== "").sort();
              ...
              <TableRow key={row.key}>
                ...
                <TableCell>
                  <FormControl fullWidth size="small" variant="standard">
                    <Select
                      value={row.scope}
                      onChange={(e) => handleScopeChange(row.scope, row.originalIndex, e.target.value)}
                      disableUnderline
                      displayEmpty
                ...
                <TableCell>
                  <TextField
                    ...
                    onChange={(e) => handleExpressionChange(row.scope, row.originalIndex, e.target.value)}
